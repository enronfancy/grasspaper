...
\begin{figure*}
    ...
    \captionof{figure}{Algorithm overview.}
    \label{fig:overview}
\end{figure*}
...
\begin{figure}
    ...
    \captionof{figure}{Skeleton refining process with a sequence of grass blade projected to 2D plane.}
...
\begin{figure}
    ...
    \captionof{figure}{Blade skeleton expansion:(a) Part of blade skeleton presented by overlapping vertices; (b) Expanded triangles from blade skeleton.}
    \label{fig:expasion}
\end{figure}
