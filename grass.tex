...
\begin{center}
    \centering
    \includegraphics[width=0.95\textwidth]{figs/test.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth,height=5cm]{figs/test2.jpg}
    \captionof{figure}{Skeleton calculation by match symmetrical points on contour.}
    \label{fig:skeleton}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth,height=5cm]{figs/test2.jpg}
    \captionof{figure}{Demonstration of Skeleton refining process with a sequence of grass blade projected to 2D plane.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth,height=5cm]{figs/test2.jpg}
    \captionof{figure}{Blade skeleton expansion.}
    \label{fig:expasion}
\end{figure}
