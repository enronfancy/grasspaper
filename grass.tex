...
\begin{figure*}
    ...
    \captionof{figure}{Experiment results:(a) blade similar to most leaves, blade edge is quadratic curve like; (b) blade that is slender than the first one, blade edge is still regular (c) bamboo leaf which is thin, its edge is very smooth and flat except for its top and root; (d) leaf with shape variation, it has a very sharp and narrow tip.}
    \label{fig:results}
\end{figure*}
